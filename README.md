...
## 🛡️ Escudo de Entropia: Inteligência Defensiva
- **Modo Cautela (Entropia > 0.60):** Reduz alavancagem em 50% e abre o Stop Loss em 20%.
- **Modo Sobrevivência (Entropia > 0.75):** Reduz alavancagem em 80% e abre o Stop Loss em 40%.
- **Pure Chaos Kill-Switch (Entropia > 0.85):** Aborta qualquer nova execução para evitar o "moedor de carne".
...
## 📊 Histórico de Desempenho (v371.0+)
Resultados validados em backtest (Janeiro 2026):
* **BTC:** +88,34% (Classificação: SOBERANO)
